...
for model_id in range(20):
    ...
    y_acc, di, dd, s_acc = my_model.evaluate([test_data, test_protected_one_hot], [test_labels_one_hot, test_protected_one_hot, test_robustness],
                                             [test_labels, test_protected, np.ones_like(test_protected)])
