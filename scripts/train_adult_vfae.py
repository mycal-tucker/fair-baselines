...
for model_id in range(20):
    ...
    my_model = VFAE(input_size, [2, 2], weights, batch_size=100, hidden_dim=100, latent_dim=50)
    my_model.train((train_data, [train_labels_one_hot, train_protected_one_hot, train_protected]), num_epochs=num_epochs)
